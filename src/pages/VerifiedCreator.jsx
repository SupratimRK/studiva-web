...
const VerifiedCreator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (isNaN(uploads) || uploads < 0) {
      setError('Please enter a valid number for weekly uploads.');
      return;
    }
        ...
        <div className="vc-form-wrapper">
          {submitted ? (
            ...
            <div className="vc-success">
              ...
              <button className="vc-success__home-btn" onClick={navigateHome}>
                ← Back to Home
              </button>
            </div>
          ) : (
            ...
            <>
              ...
              <form onSubmit={handleSubmit} autoComplete="off">
                ...
                <div className="vc-field">
                  <label className="vc-field__label" htmlFor="vc-fullname">
                    Full Name
                  </label>
                  <input
                    id="vc-fullname"
                ...
                {/* Email */}
                <div className="vc-field">
                  <label className="vc-field__label" htmlFor="vc-email">
                    Email Address
                  </label>
                  <input
                    id="vc-email"
                ...
                {/* Phone */}
                <div className="vc-field">
                  <label className="vc-field__label" htmlFor="vc-phone">
                    Phone Number
                  </label>
                  <input
                    id="vc-phone"
                ...
                {/* Weekly uploads */}
                <div className="vc-field">
                  <label className="vc-field__label" htmlFor="vc-uploads">
                    Contents per Week
                  </label>
                  <input
                    id="vc-uploads"
                ...
                {/* Social Links */}
                <div className="vc-field">
                  <label className="vc-field__label" htmlFor="vc-socials">
                    Social Links <span className="vc-optional">(optional)</span>
                  </label>
                  <textarea
                    id="vc-socials"
                ...
                <div className="vc-toggle">
                  <button
                    ...
                    onClick={toggleTeam}
                    aria-pressed={form.has_team}
                    aria-label="Do you have a team?"
                  />
                  <span className="vc-toggle__label">Do you have a team?</span>
                </div>

                {/* Team size — visible only when has_team */}
                {form.has_team && (
                  <div className="vc-field" style={{ marginTop: -6 }}>
                    <label className="vc-field__label" htmlFor="vc-teamsize">
                      Team Size
                    </label>
                    <input
                      id="vc-teamsize"
                ...
                {error && (
                  <div className="vc-form__message vc-form__message--error">
                    {error}
                  </div>
                )}
